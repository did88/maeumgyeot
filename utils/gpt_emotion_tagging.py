...
EMOTION_LEXICON_EXTENDED = {
    "분노": [
        "화나", "짜증", "열받", "미치겠", "빡쳐", "성질", "분노", "환장", "짜증나", "울컥", "짜증남",
        "죽여버리고", "도저히 못 참겠", "개빡쳐", "돌겠다", "부들부들", "손이 부들", "때려치우고 싶어"
    ],
    "슬픔": [
        "슬퍼", "눈물", "상실", "비참", "우울", "속상", "서럽", "마음 아파", "찢어질", "무너져", 
        "허탈", "견딜 수 없어", "이별", "그리움", "상처받", "자괴감"
    ],
    "불안": [
        "불안", "긴장", "떨려", "무서워", "공포", "초조", "불편해", "불안정", "혼란스러워", "겁나",
        "두려워", "패닉", "심장이 벌렁", "불길", "안절부절", "식은땀"
    ],
    "외로움": [
        "외로", "혼자", "고독", "적적", "그리워", "허전", "텅빈", "의지할 데 없", "사람이 그리워",
        "연락 없", "마음 붙일 곳", "쓸쓸", "기댈 사람", "혼밥", "혼술"
    ],
    "사랑": [
        "사랑", "좋아해", "설레", "보고싶", "애틋", "그리워", "연인", "이뻐", "잘생겼", "사랑스러워",
        "두근", "썸", "짝사랑", "애정", "고마워", "같이 있고 싶어", "끌려"
    ],
    "기쁨": [
        "기뻐", "행복", "즐거워", "신나", "웃겨", "좋아", "재밌어", "기대돼", "행복감", "감동이야",
        "뿌듯", "힐링", "소름", "짱이야", "대박", "미쳤다", "살맛나"
    ],
    "지루함": [
        "지루", "심심", "따분", "흥미없", "노잼", "할 게 없어", "하품", "시큰둥", "의욕 없",
        "시간 안 가", "멍함", "답답해", "망할 루틴", "무기력"
    ],
    "후회/자기비판": [
        "후회", "자책", "내탓", "실수", "바보같", "창피", "민망", "못났어", "왜 그랬을까",
